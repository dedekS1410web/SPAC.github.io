        ...
        <div class="main-panel">
            ...
            <div class="dropdown pull-left">
                ...
                <ul class="dropdown-menu dropdown-menu-right" role="menu">
                    <li>
                        <a href="parts.php">Add Part</a>
                    </li>
                    <li>
                        <a href="parts.php">Import Parts</a>
                    </li>
                </ul>
            </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <h4 class="card-title"> Parts Data</h4>
                     </div>
                            ...
                            <div class="card-footer">
                                <table id="parts" name="parts" class="table table-hover">
                                  ...
                                  <tbody>
                                    ...
                                    ?>
                                    <tr>
                                      <td><?php echo $checkdata_parts_value['part_name']; ?></td>
                                      ...
                                      <td><a href=" " class="btn btn-round btn-info">Details</a></td>
                                    </tr>
                                    <?php } ?>
                                  </tbody>
                                </table>
...
<!-- <script>
    ...
    $(document).ready(function() {
        tabel = $('#parts').DataTable({
            ...
            "ajax":
            {
                "url": "https://us-central1-spac-demo.cloudfunctions.net/webApi/parts", // URL file untuk proses select datanya
                "type": "POST"
            },
            "deferRender": true,
