...
<body>
    ...
    <div class="logo logo-mini">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                  ...
                  <div class="col-md-3 col-sm-6 col-xs-12">
                        ...
                        <ul class="nav nav-tabs nav-justified nav-tabs-dropdown" role="tablist">
                          <li role="presentation"><a href="#incoming" aria-controls="incoming" role="tab" data-toggle="tab">Incoming</a></li>
                          ...
                          <li role="presentation" class="active"><a href="#quality" aria-controls="quality" role="tab" data-toggle="tab">Quality</a></li>
            ...
            <script>
                $('#scanned').DataTable().ajax.reload(null, false);
            </script>
            <!-- batas konten -->
            <footer class="footer">
                <div class="container-fluid">
